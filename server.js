...
validatePhone(phone) {
    ...
    // Patrones fraudulentos
    const fraudPatterns = [
        /^(\d)\1{9,}$/,           // 1111111111
        /^1234567890$/,           // Secuencia
        /^0987654321$/,           // Secuencia inversa
        /^0{10,}$/                // Puros ceros
    ];
    ...
    // Aceptar números con prefijo de Cuba (+53) y otros países
    return true;  // Simplificado para aceptar números reales
}
