...
app.post('/api/pedidos', async (req, res) => {
    ...
    console.log('📦 Pedido recibido:', { cliente, producto, total, estado });
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`✅ API de Pedidos: ACTIVADA (/api/pedidos)`);
    console.log(`✅ Manifiesto PWA: DISPONIBLE (/manifest.json)`);
